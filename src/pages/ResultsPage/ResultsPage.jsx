...
Prepaid Phones Sold: ${data.prePaidPhones},
    ...
    <div className="results-page">
      <Link to="/">
        <button className="back-btn">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-arrow-left-square-fill" viewBox="0 0 16 16">
      ...
      <div className="results">
        ...
        <p>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="blue" className="bi bi-shield-shaded" viewBox="0 0 16 16">
          ...
          Insurance Sold: {data.insuranceCount}
        </p>
        <p>
          ...
          AppleCare Sold: {data.appleCareCount}
        </p>
        <p>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="orange" className="bi bi-phone" viewBox="0 0 16 16">
        ...
        <p>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" className="bi bi-headphones" viewBox="0 0 16 16">
            <path d="M8 3a5 5 0 0 0-5 5v1h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V8a6 6 0 1 1 12 0v5a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h1V8a5 5 0 0 0-5-5"/>
          </svg>
          Accessories: ${data.accesoriesDollarAmount}
        </p>
        <p>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="yellow" className="bi bi-controller" viewBox="0 0 16 16">
